 ...
 * 
 * Este programa envía datos  por Internet a través del protocolo MQTT y los datos son recuperados por openhab
 * 
 * Componente   PinESPCAM32CAM    Estados lógicos
...
#include "DHT.h" // bliblioteca del DHT11

//constantes 
#define DHTPIN 14 //pin el que se conecta al sensor DHT11
#define DHTTYPE DHT11 //var para selección del modelo

//Datos de WiFi
const char* ssid = "INFINITUM92A4_2.4";  // Aquí debes poner el nombre de tu red
const char* password = "htw4ThzYcy";  // Aquí debes poner la contraseña de tu red
...
DHT dht(DHTPIN,DHTTYPE); //obj para el DHT
...
void setup() {
  ...
  //iniciar obj que maneja el sensor
  dht.begin();
